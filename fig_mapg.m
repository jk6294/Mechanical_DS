...
text(.05,.74,'unit 1',NVTextH{:},'color',[0 0 0]);
text(.135,.74,'unit 2',NVTextH{:},'color',o*gr^2);
text(.262,.74,'unit 2',NVTextH{:},'color',[0 0 0]);
text(.468,.74,'unit 3',NVTextH{:},'color',[0 0 0]);
text(.02,.68,'glue together',NVTextR{:},'color',o*gr^2);
text(.8,.974,'periodic state',NVTextH{:});
text(.8,.24,'periodic state',NVTextH{:});
