...
% Text
textd = '\textbf{d} \hspace{0.3mm}marginally stable';
text(labX-.6,subp(pInd,4)+labY,textd,NVTitle{:});
...
texte = '\textbf{e} \hspace{0.3mm}superstable';
text(labX+2.65,subp(pInd,4)+labY,texte,NVTitle{:});
