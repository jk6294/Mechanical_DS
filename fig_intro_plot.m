...
% DOF equation
text(0,.28,'$4$ nodes:',NVTextL{:});
text(0,.16,'$4$ edges:',NVTextL{:});
text(1.0,.28,'$+8$ motions',NVTextR{:});
text(1.0,.16,'$-4$ motions',NVTextR{:});
text(1.0,.0,'$4$ motions',NVTextR{:});
...
text(0.0,.83,'x shift',NVTextL{:});
text(0.5,.83,'y shift',NVTextH{:});
text(1.0,.83,'rotation',NVTextR{:});
