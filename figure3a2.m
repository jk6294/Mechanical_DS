...
visualize_network(XC1(:,1:nS1,end)*netSc+netSh1-xcd1*netSc,...
                  XC1(:,nS1+1:end,end)*netSc+netSh1-xcd1*netSc,conna1,...
                      'scale',pSc,'scolor',C_SN,'ucolor',cTr1);
hold on;
...
visualize_network(XC1(:,1:nS1,1)*netSc+netSh1,...
                  XC1(:,nS1+1:end,1)*netSc+netSh1,conna1,...
                      'scale',pSc,'scolor',C_SN,'ucolor',cTr1);
...
visualize_network(XC2(:,1:nS1,end)*netSc+netSh2-xcd2*netSc,...
                  XC2(:,nS1+1:end,end)*netSc+netSh2-xcd2*netSc,conna1,...
                      'scale',pSc,'scolor',C_SN,'ucolor',cTr1);
hold on;
...
visualize_network(XC2(:,1:nS1,1)*netSc+netSh2,...
                  XC2(:,nS1+1:end,1)*netSc+netSh2,conna1,...
                      'scale',pSc,'scolor',C_SN,'ucolor',cTr1);
